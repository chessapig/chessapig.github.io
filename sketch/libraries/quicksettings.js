...
(function () {
    ...
    var QuickSettings = {
        ...
        setValuesFromJSON: function (json) {
            ...
            for (var title in json) {
                if (this._controls[title] && this._controls[title].setValue) {
                    //console.log("quicksettings line 202");console.log(json["preset"]);
        ...
        addDropDown: function (title, items, callback) {
            ...
            //console.log("quicksettings line 948");console.log(select);
            ...
            this._controls[title] = {
                ...
                setValue: function (value) {
                    var index
                    //console.log("quicksettings line 990");console.log(value.index);
                    if (value.index != null) {
                        index = value.index;
                    }
                    else {
                    ...
                    //console.log("quicksettings line 999");console.log(this.control.selectedIndex);
                    var options = this.control.options;
                    this.control.selectedIndex = index;
                    //console.log("quicksettings line 1002");console.log(index);
                    if (callback) {
                        callback({
                            index: index,
                            label: options[index].label,
