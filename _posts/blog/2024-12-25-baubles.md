...
<div class="container" >
	  <div class="row justify-content-center">
	    <div class="col-md-6 border p-4 filter-buttons">
	      ...
	      <li>Click and drag to move lines, Scroll to zoom</li>
	...
	<div class="row justify-content-center align-items-center">
	  ...
	  <div class="col-12 col-md-5 text-center">
		<div class="card my-4 shadow-sm" style="max-width: 400px; margin: auto;">
		  ...
		  <div class="card-body text-center">
		    <p class="card-text"> A regulus is another name for a hyperbolic paraboloid, or a hyperboloid. <a href="/craft/hyperbolic-origami#slide=hypar">See my page on origami hyperbolic paraboloids</a>
		    </p>
		  </div>
		</div>
	  </div>
...
This is a map from a 10 dimensional space to a nine dimensional space. By the rank-nullity theorem, $ev$ must always have a zero. That is, there is always a quadratic $f$ vanishing on all nine points.  By the lemma above, this $f$ vanishes identically on $\ell_0,\ell_1, \text{ and } \ell_2$.
