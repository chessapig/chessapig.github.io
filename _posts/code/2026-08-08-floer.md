                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="hamiltonianSelect" onchange="loadHamiltonianFromFile(this.value)">
                            ...
                            <option value="data_inflection.json">Mexican hat</option>
...
- The homology of this chain complex is isomorphic to the reduced homology of the underlying manifold, so $HF^*(M,H) \cong H^*(M)$. In particular, for any Hamiltonian on  $\mathbb{R}^2$, the Hamiltonian Floer homology is trivial.
...
[^3]: Searching for J-holomorphic curves via machine: first steps
