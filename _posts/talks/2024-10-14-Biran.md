...
The decomposition of $\CC$ into the blobs $D_i$ is known as the *Brian decomposition*. Each of the blobs has the same area! In particular, if $z_i$ is an isolated zero of $f$, then the stable manifold $D_i$ has area $\pi / 2k$. Let me prove this.
