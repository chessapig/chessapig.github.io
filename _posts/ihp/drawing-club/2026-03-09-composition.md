...
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  ...
  <div class="card-body text-center">
    ...
    <p class="card-text"> <b>Left:</b> A square rearranged to suggest a circle 
    <br>
    <b>Right:</b> A circle rearranged to suggest a square</p>
  </div>
</div>
...
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  ...
  <div class="card-body text-center">
    <h5 class="card-title"> Circle - Vladimir</h5>
	    <p class="card-text"> A circle, rearranged, can be made rigid or flexible  </p>
  </div>
</div>
