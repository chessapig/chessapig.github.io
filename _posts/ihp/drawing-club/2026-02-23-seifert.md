...
tags:
  - drawing-club
week: 4
image: /assets/drawing-club/seifert/assembled.jpeg
file: /assets/drawing-club/seifert/worksheet.pdf
...
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  <img src="/assets/drawing-club/seifert/samuel.jpeg" alt="Knot winding around the paper. Every other region is white, while the colored regions are many colors" class="card-img-top" >
...
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  <img src="/assets/drawing-club/seifert/rebecca.jpeg" alt="Knot winding around the paper. Every other region is white or orange. There is a black border on one side of the curve" class="card-img-top" >
...
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  <img src="/assets/drawing-club/seifert/alternating.jpeg" alt="many pieces of paper lined up on a table. Each piece has a drawing, which is alaternating regions of white and color." class="card-img-top" >
...
Next, we learned to draw Seifert surfaces, following my guide in the [worksheet](/assets/drawing-club/seifert/worksheet.pdf). We then all together built a very complicated Seifert surface.
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  <img src="/assets/drawing-club/gallery/exquisite.jpeg" alt="many small squares, each with some surfaces drawn on the,. The squares are all assembled togehter, so the surfaces line up and get one very large surface" class="card-img-top" >
...
<div class="card my-4 shadow-sm" style="max-width: 300px; margin: auto;">
  <img src="/assets/drawing-club/seifert/square.png" alt="a small rectangle. There are marks on each side, a black square on 2 corners, and a little rivet on the other 2. " class="card-img-top" >
...
<div class="card my-4 shadow-sm" style="max-width: 600px; margin: auto;">
  <img src="/assets/drawing-club/seifert/truchet_small.jpeg" alt="Many squares like above, layed out in a way to make the exquisite corpse " class="card-img-top" >

  <div class="card-body text-center">
    <p class="card-text">template for the exquisite corpse. Click <a href="/assets/drawing-club/seifert/truchet.jpeg"> here </a> for full sized template </p>
  </div>
</div>