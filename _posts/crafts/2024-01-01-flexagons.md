...
tags:
  ...
  - math-crafts-class
week: 0
image: /assets/crafts/flexagons/flexagons.jpeg
...
1. Can you find the three sides? What is an easy way to go between sides?
2. What basic shapes are the paper folded into? How many of them are there?
3. How can you fold many of these shapes from a paper strip? Can you do it without using the preexisting hexagon?
4. Try to assemble a triangled strip into the hexaflexagon.
...
- Make sure you show them that it has 3 sides. If you don't they will try to repoduce the object without ever flexing it.
- Try to ensure people talk to their tablemates when they get stuck.
- Some people took the whole hour for this and didn't figure it out, others saw it before and got one reasonably quickly. No one figured out the hexaflexagon.
</div></div></div><br>


**Second goal: Hexahexaflexagons** Next hand them a hexahexaflexagon, and ask them to make it. 
...
Here is the fold state diagram: 

<div class="text-center">
<img src="/assets/crafts/flexagons/flexagons.jpeg" alt="collection of hexaflexagons on a table, with arrows betweeen them" width="500" >
</div>

An arrow between two colors means you can flex one to get to the other. Some have two arrows going out, meaning there are two ways to flex. There is a central cycle of 3 colors which all allow two types of flexing. Each of these colors then splits off into its own cycle. You can see the initial 3 colors reappearing as a different state, where the outside and outside are flipped.
