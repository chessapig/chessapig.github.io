...
tags:
  ...
  - gallery
week: 1
image: /assets/crafts/polyhedra/gallery/all_polyhedra.jpg
...
pageHasContent: true
gallery-title: Paper polyhedra
gallery-folder: /assets/crafts/polyhedra/gallery
gallery-captions:
  - image: all_polyhedra
    title: "all polyhedra in a line"
    caption: ""
  - image: tetrahedron
    title: "Tetrahedron"
    caption: 
  ...
  - image: banner
    title: ""
    caption: 
  - image: curvature_line
    title: "Assorted polyhedra"
    caption: |
      All the kids in my class made various polyhedra. The only rule was, every vertex needs to be composed of the same set of regular polygons. This is all the polyhedra from class, organized by the sum of the angles at each vertex. As the sum of the angles get larger, the polyhedron also gets larger. In effect, these are ordered from increasing to decreasing curvature.
  - image: snub
    title: "snub dodecahedron"
    caption: |
      12 pentagons, 80 triangles. A lot of paper.
---
...
<img src="/assets/crafts/polyhedra/gallery/banner.jpg" alt="all platonic solids in a cluster" height="400" >
</div>
...
<div class="text-center">
<img src="/assets/crafts/polyhedra/gallery/tetrahedron.jpg" alt="paper model of tetrahedron" height="300" >
</div>
 
**4 triangles per vertex:** This results in the 8-sided octahedron

<div class="text-center">
<img src="/assets/crafts/polyhedra/gallery/octahedron.jpg" alt="paper model of octahedron" height="300" >
</div>

**5 triangles per vertex:** This results in the 20-sided icosahedron

<div class="text-center">
<img src="/assets/crafts/polyhedra/gallery/icosahedron.jpg" alt="paper model of icosahedron" height="300" >
</div>
...
<div class="text-center">
<img src="/assets/crafts/polyhedra/gallery/cube.jpg" alt="paper model of cube" height="300" >
</div>
...
<div class="text-center">
<img src="/assets/crafts/polyhedra/gallery/dodecahedron.jpg" alt="paper model of dodecahedron" height="300" >
</div>
...
<div class="text-center">
<img src="/assets/crafts/polyhedra/gallery/curvature_line.jpeg" alt="many paper polyhedra, all in line. They are sorted by angle defect, which happens to correspond to sorting by size" width="80%" > </div>
