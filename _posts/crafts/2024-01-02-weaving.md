...
tags:
  ...
  - gallery
week: 2
image: /assets/crafts/weaving/gallery/everyone.jpeg
...
pageHasContent: true
gallery-title: Weaving pipe cleaners
gallery-folder: /assets/crafts/weaving/gallery
gallery-captions:
  - image: everyone
    title: "all my woven shapes together"
    caption: ""
  - image: tiling_7_3
    title: "The hyperbolic plane"
    caption: |
      A rendition of the hyperbolic plane. This one has 3 layers of a $\{7,3\}$ tiling (3 heptagons at each vertex). See the page above for details on the construction. 
  - image: laying
    title: "one hyperbolic point"
    caption: |
      This weave is mostly flat, except for a single area with negative curvature. Instead of 6 pipecleaners forming a hexagon, there are nine. This negative curvature forces the rest of the weave to distort, unable to lie flat.
  - image: hatavine
    title: "one hyperbolic point, as a hat"
    caption: 
  - image: spheres
    title: "woven pipe cleaner spheres"
    caption: |
      Two woven spheres, made using a Kagome-like design. On the left, $\{4,3\}$ lattice (4 triangles at each vertex, like an octahedron). On the right, a  $\{5,3\}$ lattice (5 triangles at each vertex, like an icosahedron). These tilings give spherical geometry instead of hyperbolic geometry. The left ball is made with 4 pipe cleaners, each tied into a circle. The right ball uses 6 pipe cleaners. See the article above for details of construction. 
---
...
- People thought that every pair of colors had to weave togehter, not following the rule that every intersection has to alternate.
...
<div class="text-center">
<img src="/assets/crafts/weaving/gallery/laying.jpeg" alt=" pipe cleaner object. There are hexagons everywhere, except the very center, which has a nonagon" height="300" >
</div>
...
<div class="text-center"><img src="/assets/crafts/weaving/gallery/hatavine.jpeg" alt="mischevious looking human wearing pipe cleaners as a hat" height="300" ></div>
</div></div></div><br>
...
<div class="text-center"><img src="/assets/crafts/weaving/gallery/spheres.jpeg" alt="two pipe cleaner spheres, one with a balloon in it" height="300" ></div>
...
<div class="text-center"><img src="/assets/crafts/weaving/icosahedron_ballon.jpeg" alt="Now the icosohedron is full of a baloon. " height="300" ></div>
...
<div class="text-center"><img src="/assets/crafts/weaving/gallery/tiling_7_3.jpeg" alt="" height="300" ></div>
...
<div class="text-center"><img src="/assets/crafts/weaving/gallery/everyone.jpeg" alt="" height="300" ></div>
